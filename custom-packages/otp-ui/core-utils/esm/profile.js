...
function optionToItinerary(option, query) {
  ...
  } else if (option.modes.length === 1 && option.modes[0] === "bicycle") itin.summary = "Bicycle";else if (option.modes.length === 1 && option.modes[0] === "walk") itin.summary = "Walk";else if (option.modes.indexOf("bicycle_rent") !== -1) itin.summary = "Bikeshare";
