  ...
  render() {
    ...
    return (
      <>
        ...
        <LocationSummaryContainer className="locations-summary-container">
          <LocationsSummaryRow className="locations-summary">
            <LocationsSummaryColFromTo
              className="locations-col-from-to"
              sm={11}
              xs={8}
            >
              <LocationContainer className="locations-container-from">
                <StyledLocationIcon type="from" />{' '}
                {query.from ? query.from.name : ''}
              </LocationContainer>
              <LocationContainer
                className="locations-container-to"
                style={{ marginTop: 2 }}
              >
                <StyledLocationIcon type="to" /> {query.to ? query.to.name : ''}
              </LocationContainer>
            </LocationsSummaryColFromTo>
            <Col className="search-button-col" sm={1} xs={4}>
