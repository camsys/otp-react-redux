import flatten from "flat"; // eslint-disable-next-line @typescript-eslint/ban-ts-comment
...
var hasTransit = coreUtils.itinerary.hasTransit;
...
export function getQueryParamMessagesWithI18n(intl) {
  return {
    ...
    optimizeBike: {
      ...
      options: function options(queryParams) {
        return getBikeTripOptions(intl, queryParams);
      }
    },
    maxWalkTime: {
      label: /*#__PURE__*/React.createElement(FormattedMessage, {
