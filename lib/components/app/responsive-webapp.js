      ...
      <div className="otp">
        ...
        <div className="sidebar-footer">
          {ContactLink &&
            ...
            !ContactLink.defaultProps.menuOnly && <ContactLink />}
          {ContactLink &&
            surveyProps &&
            !!surveyProps.linkText &&
            !!surveyProps.linkHref &&
            !surveyProps.menuOnly && (
              <ContactLink
                linkHref={surveyProps.linkHref}
                linkText={surveyProps.linkText}
                menuOnly={surveyProps.menuOnly}
              />
            )}
        </div>
        <Grid>
